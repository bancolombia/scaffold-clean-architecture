...
class ApiConfigTest {
    ...
    void setUp() {
        ...
        when(configurer.addSupportedVersions("1.0", "2.0")).thenReturn(configurer);
        when(configurer.setDefaultVersion("1.0")).thenReturn(configurer);
    ...
    void shouldConfigureApiVersioningWithSupportedVersions() {
        ...
        verify(configurer).addSupportedVersions("1.0", "2.0");
    }

    @Test
    void shouldConfigureApiVersioningWithDefaultVersion() {
        apiConfig.configureApiVersioning(configurer);
        verify(configurer).setDefaultVersion("1.0");
    }
    ...
    void shouldCallConfigurerMethodsInCorrectOrder() {
        ...
        inOrder.verify(configurer).addSupportedVersions("1.0", "2.0");
        inOrder.verify(configurer).setDefaultVersion("1.0");
    ...
    void shouldSupportExactlyTwoVersions() {
        ...
        verify(configurer, times(1)).addSupportedVersions("1.0", "2.0");
        verify(configurer, never()).addSupportedVersions("3.0");
    }
}