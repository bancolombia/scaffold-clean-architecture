...
public class Constants {
  ...
  public static final String SPRING_BOOT_VERSION = "3.0.4";
  public static final String SONAR_VERSION = "4.0.0.2929";
  ...
  public static final String PLUGIN_VERSION = "3.0.0-example";
