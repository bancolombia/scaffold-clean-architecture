...
public final class Constants {
  ...
  // dependencies
  public static final String SECRETS_VERSION = "4.4.17";
  ...
  public static final String AWS_BOM_VERSION = "2.27.2";
  public static final String COMMONS_JMS_VERSION = "2.2.16";
