...
public final class Constants {
  ...
  public static final String REACTIVE_COMMONS_VERSION = "7.2.0";
  ...
  public static final String AWS_BOM_VERSION = "2.44.7";
  ...
  public static final String SPRING_MCP_SECURITY_VERSION = "0.1.9";
