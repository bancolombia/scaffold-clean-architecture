...
public final class Constants {
  ...
  public static final String AWS_BOM_VERSION = "2.42.13";
  ...
  public static final String SPRING_MCP_SECURITY_VERSION = "0.1.2";
  ...
  // custom
  public static final String GRADLE_WRAPPER_VERSION = "9.3.1";
