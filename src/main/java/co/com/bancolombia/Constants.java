...
public final class Constants {
  ...
  // dependencies
  public static final String SECRETS_VERSION = "4.4.1";
  public static final String SPRING_BOOT_VERSION = "3.2.5";
  public static final String LOMBOK_VERSION = "1.18.32";
  public static final String REACTIVE_COMMONS_VERSION = "2.1.1";
  ...
  public static final String AWS_BOM_VERSION = "2.25.35";
  public static final String COMMONS_JMS_VERSION = "2.2.2";
  ...
  public static final String BIN_STASH_VERSION = "1.2.4";
  ...
  public static final String PLUGIN_VERSION = "3.16.1";
