 ...
 *
 * <ul>
 *   <li>A2A domain models (A2ARequest, A2AResponse, etc.)
 ...
 *   <li>WebFlux functional router (POST /a2a/v1/commands)
 *   <li>SpringAiChatAdapter (implements ChatGateway via Spring AI ChatClient)
...
public class EntryPointAgent implements ModuleFactory {
  ...
  public void buildModule(ModuleBuilder builder) throws IOException, CleanException {
    ...
    if (agentName == null || agentName.isBlank()) {
      agentName = builder.getProject().getName();
    }
